...
export default function SettingsModal() {
    ...
    return (
        <div className="h-200 w-170 bg-surface flex text-text-primary ring ring-border rounded-xl">
            <div className="w-full mx-10 mt-10 mb-auto flex flex-col gap-7.5">
                ...
                <div className="flex flex-col gap-3.75">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex flex-col gap-1.25 mr-28">
                        ...
                        <button className="px-2.5 py-1.25 text-[11px] border border-border rounded-[3px]">Cambiar Contraseña</button>
                    </div>
                    <div className="flex items-center justify-between">
                        <div className="flex flex-col gap-1.25 mr-28">
                        ...
                        <button className="px-2.5 py-1.25 text-[11px] border border-border rounded-[3px]">Agregar un Método de Verificación</button>
                    </div>
                    <div className="flex items-center justify-between">
                        <div className="flex flex-col gap-1.25 w-97.5">
                        ...
                        <button className="px-2.5 py-1.25 text-[11px] border border-error rounded-[3px] bg-error/40 ">Eliminar mi Cuenta</button>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-3.75">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button className="px-2.5 py-1.25 text-[11px] border border-border rounded-[3px]">Vincular</button>
                    </div>
                    <div className="flex items-center justify-between">
                        <div className="flex flex-col gap-1.25 w-97.5">
                        ...
                        <button className="px-2.5 py-1.25 text-[11px] border border-border rounded-[3px]">Cambiar Frecuencia</button>
                    </div>
                </div>
            </div>
        </div>
