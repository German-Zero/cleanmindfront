...
export function Calendar() {
    ...
    return (
        <div className="h-full min-h-144 w-full min-w-0 max-w-7xl xl:h-auto xl:min-h-0">
            <div className="flex h-full w-full flex-col overflow-hidden bg-transparent px-1 sm:px-2 xl:h-auto xl:rounded-2xl xl:border xl:border-border/65 xl:bg-surface/94 xl:px-8 xl:py-6 xl:shadow-[0_18px_48px_rgb(0_0_0/14%)] 2xl:px-10.5 2xl:py-7">
